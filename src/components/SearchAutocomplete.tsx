  ...
  return (
    <div ref={wrapperRef} className="relative w-full max-w-2xl mx-auto">
      ...
      {isOpen && results.length > 0 && (
        <div className="absolute z-10 w-full mt-2 bg-slate-800/95 backdrop-blur-xl rounded-xl md:rounded-2xl shadow-2xl border border-slate-700/80 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="px-3 md:px-4 py-2 md:py-3 border-b border-slate-700/50 bg-slate-900/50">
            <span className="text-[10px] md:text-xs font-semibold text-slate-400 uppercase tracking-wider">
              {results.length} rezultate găsite
            </span>
          </div>
          <ul className="max-h-[50vh] md:max-h-72 overflow-y-auto overscroll-contain">
