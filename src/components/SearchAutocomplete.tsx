  ...
  return (
    <div ref={wrapperRef} className="relative w-full max-w-2xl mx-auto">
      ...
      {isOpen && results.length > 0 && (
        <div className="absolute z-10 w-full mt-2 md:mt-3 bg-slate-800 rounded-xl md:rounded-2xl shadow-2xl border border-slate-700 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <ul className="max-h-72 overflow-y-auto">
            {results.map((provider, index) => (
              <li
                ...
                className="px-4 py-3 cursor-pointer hover:bg-slate-700/50 border-b border-slate-700/50 last:border-0 transition-all group/item"
              >
                <div className="flex items-center gap-3">
                  <div className="shrink-0 w-10 h-10 rounded-full bg-linear-to-br from-sky-400 to-violet-500 flex items-center justify-center text-white font-bold shadow-lg">
                  ...
                  <svg className="w-5 h-5 text-slate-500 group-hover/item:text-sky-400 group-hover/item:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
